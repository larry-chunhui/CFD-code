...
!-------------------------------------------------------
	  ...
	  subroutine teno5(Ka,Kb,fpa,fma,f)    !输入Kl,Kr
!	  use var
	  implicit none
	  integer Ka,Kb
!	  real*8,dimension(:),allocatable:: fpa,fma
	  ...
	  real*8 fpa(Ka:Kb),fma(Ka:Kb)
        ...
        call flux_P_teno5(Ka,Kb,fpa,fpx)
 	    call flux_M_teno5(Ka,Kb,fma,fmx)
		f=fpx+fmx
	  return
	  end
!!-------------------------------------------------------
!  5阶TENO格式（正通量）
      subroutine flux_P_teno5(Ka,Kb,v,v1)
      implicit none
	  integer:: Ka,Kb
...
!-------------------------------------------------
!  5阶TENO格式 （负通量）
      subroutine flux_M_teno5(Ka,Kb,v,v1)
      implicit none
	  integer:: Ka,Kb
	  real*8:: v(Ka:Kb),v1
      real*8:: ep,C03,C13,C23,S0,S1,S2,a0,a1,a2,W0,W1,W2,q03,q13,q23
