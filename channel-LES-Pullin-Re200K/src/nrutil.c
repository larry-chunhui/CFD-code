...
/* Additions:
 ...
 '#include "definitions.h"'                          Date: 13 May  1998
 function *pvector(long nl, long nh)                       13 May  1998
 function free_pvector(particle *v, long nl, long nh)      13 May  1998
 function ***d3tensor(...)                                 17 June 1998
 function free_3dtensor(...)                               17 June 1998
 function related to fftw deleted							 08 Jan  2009
 function ***i3tensor(...)                                 10 Feb  2009
 function free_i3tensor(...)                               10 Feb  2009
...
/* allocate a integer 3d tensor with range t[nrl..nrh][ncl..nch][ndl..ndh] */
{
	long i,j,nrow=nrh-nrl+1,ncol=nch-ncl+1,ndep=ndh-ndl+1;
	int ***t;
...
void free_i3tensor(int ***t, long nrl, long nrh, long ncl, long nch,
                   long ndl, long ndh)
/* free a integer 3d tensor allocated by i3tensor() */
{
	free((FREE_ARG) (t[nrl][ncl]+ndl-NR_END));
	free((FREE_ARG) (t[nrl]+ncl-NR_END));
	free((FREE_ARG) (t+nrl-NR_END));
